...
class CommentaireController extends AbstractController
{
    ...
    public function addComment(Request $request, Blog $blog  ,   SessionInterface $session): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('blog_index');  // Adjust route as necessary
        }
